...
```go
const MaxLenG = <computed_at_generation>  // Maximum path length in asset set
```
...
var dispatch [MaxLenG]func(http.ResponseWriter, *http.Request)
dispatch[idx](w, r)
```
...
**Algorithm:**
1. Compute MaxLenG = maximum path length in asset set
2. Create dispatch array of size MaxLenG+1
